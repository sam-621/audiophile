...
export class ProductService {
  static async getAllProducts(): Promise<ServiceResponse<TEntityWithId<IProduct>[]>> {
  ...
  static async getProductById(id: TMongoId): Promise<ServiceResponse<TEntityWithId<IProduct>>> {
    const productRepository = new ProductRepository()
